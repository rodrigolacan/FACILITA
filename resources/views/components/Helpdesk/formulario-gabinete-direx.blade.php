<form action="{{route('criarHelpPost')}}" method="post">
    ...
    <div class="bg-gray-200 p-5 rounded-md">
        <input type="hidden" name="unidade" value="Help Desk - Gabinete Direx">
        <input type="radio" value="Padrão" name="tipo" id="padrao-direx" x-model="selectedPattern" class="mr-2" checked>
        <label for="padrao-direx" class="inline-block mb-2">Padrão</label><br>
