<form action="{{route('criarHelpPost')}}" method="post">
    ...
    <div class="bg-gray-200 p-5 rounded-md">
        <input type="hidden" name="unidade" value="Help Desk - OUVIDORIA">
        <input type="radio" value="Padrão" name="tipo" id="padrao-ouvidoria" x-model="selectedPattern" class="mr-2" checked>
        <label for="padrao-ouvidoria" class="inline-block mb-2">Padrão</label><br>
