<form action="{{route('criarHelpPost')}}" method="post">
    ...
    <div class="bg-gray-200 p-5 rounded-md">
        <input type="hidden" name="unidade" value="Help Desk - UGP Psicólogo">
        <input type="radio" value="Padrão" name="tipo" id="tipo" x-model="selectedPattern" class="mr-2" checked>
        <label for="tipo" class="inline-block mb-2">Padrão</label><br>
