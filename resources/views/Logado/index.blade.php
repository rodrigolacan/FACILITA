...
@section('index-head')
<head>
<!-- Início do aviso de consentimento de cookies OneTrust para cut.rr.sebrae.com.br -->
<script type="text/javascript" src="https://cdn.cookielaw.org/consent/018f5d20-777f-7c92-b7ec-b3c77c9d5c38/OtAutoBlock.js" ></script>

<script src="https://cdn.cookielaw.org/scripttemplates/otSDKStub.js"  type="text/javascript" charset="UTF-8" data-domain-script="018f5d20-777f-7c92-b7ec-b3c77c9d5c38" ></script>
    ...
    <div class="pt-24">
        ...
        <div class="container max-w-5xl mx-auto m-8">
          ...
          <div class="flex flex-wrap">
            <div class="w-5/6 sm:w-1/2 p-6">
              ...
              <p class="text-gray-600 mb-8">
                  Agora você pode encurtar links com segurança e compartilhar de forma segura com os clientes do Sebrae.
                <br />
                <br />
              </p>
            </div>
          ...
          <div class="flex flex-wrap flex-col-reverse sm:flex-row">
            <div class="w-full sm:w-1/2">
              <object type="image/svg+xml" data="{{asset('/assets/Index/images/escudo.svg')}}"></object>
            </div>
            <div class="w-full sm:w-1/2  mt-10">
              <div class="align-middle">
                ...
                <p class="text-gray-600 mb-8">
                  Nós não armazenamos os nomes coletados. Após a realização do sorteio, todos os dados são imediatamente descartados.
                  <br />
                </p>
              </div>
            </div>
            ...
            <div class="w-full sm:w-1/2  mt-10">
              <div class="align-middle">
                ...
                <p class="text-gray-600 mb-8">
                  Trabalhos em um novo help desk, e para facilitar ainda mais o processo, ao abrir o help desk no facilita o novo help criado é automaticamente enviado para o bitrix24!
                </p>
              </div>
            </div>
            <div class="w-full sm:w-1/2">
              <object type="image/svg+xml" data="{{asset('/assets/Index/images/interface.svg')}}"></object>
            </div>
          </div>
        </div>
      </section>
      <section class="bg-white border-b py-8">
        <div class="container mx-auto flex flex-wrap pt-4 pb-12">
          <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
            Comece agora mesmo a usar as ferramentas!
          </h1>
          <div class="w-full mb-4">
            <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
          </div>
            ...
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                <p class="w-full text-gray-600 text-xs md:text-sm px-6">
                  COMECE A ENCURTAR SEUS LINK!
                </p>
                <div class="w-full font-bold text-xl text-gray-800 px-6">
                  Mais praticidade.
                </div>
                <p class="text-gray-800 text-base px-6 mb-5">
                  Links encurtados pelo Facilita trazem mais praticidade, engajamento e credibilidade
                </p>
              </a>
            </div>
          ...
          <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                ...
                <div class="w-full font-bold text-xl text-gray-800 px-6">
                  Segurança com o Sorteador Sebrae
                </div>
                <p class="text-gray-800 text-base px-6 mb-5">
                  O nosso sorteador garante a veracidade dos dados sorteados, e o tratamento adequado para que esses dados não sejam vazados ou armazenados de forma indevida
                </p>
              </a>
            </div>
            <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
          ...
          <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                ...
                <div class="w-full font-bold text-xl text-gray-800 px-6">
                  Mais além do Helpdesk.
                </div>
                <p class="text-gray-800 text-base px-6 mb-5">
                  Ferramentas como o helpdesk integrado são apenas o começo, estamos trabalhando para trazer mais novidades, e o melhor, queremos ouvir você para construir essas facilidades.
                </p>
              </a>
            </div>
            <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
